...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length == 0) {
            capers.Utils.exitWithError("Must have at least one argument");
        }
        ...
        case "story":
            ...
            System.out.println(readContentsAsString(capers.Utils.join(capers.CapersRepository.CAPERS_FOLDER,"story")));
            break;
        case "dog":
